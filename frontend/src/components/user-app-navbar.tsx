...
function AccountMenuPanel({ activeView, onSelectView, upcomingTicketCount, favoritesCount }: AccountMenuPanelProps) {
  return (
    <div className="festigo-account-hub-fade-in w-[min(100vw-2rem,22rem)] rounded-3xl border border-gray-100 bg-white p-5 shadow-xl shadow-gray-200/60 sm:p-6">
      <div className="flex gap-3">
        ...
        <div className="min-w-0 flex-1 pt-0.5">
          <p className="text-lg font-semibold text-gray-900 sm:text-xl">James Aldrino</p>
        ...
        <div className="group relative shrink-0">
          ...
          >
            ...
            <span className="hidden min-w-0 max-w-[9rem] sm:block">
              <span className="block truncate text-sm font-semibold text-gray-900">James</span>
              <span className="block truncate text-xs text-gray-500">Mon compte</span>
            </span>
            <ChevronDown
